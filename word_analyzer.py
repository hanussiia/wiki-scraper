...
class WordAnalyzer:
    ...
    def count_words(self, phrase: str, soup, prefix=None, postfix=None):
        ...
        print(f"""Counted {len(set(words))}
              unique words from article '{phrase}'""")
    ...
    def analyze_relative_word_frequency(self, mode, n, chart_path):
        ...
        if mode == "article":
            sorted_article = sorted(article_counts.items(),
    ...
    def auto_count_words(self, phrase: str, depth: int, t: int):
        ...
        while depth > 0:
            ...
            if depth > 1:
                ...
                print(f"""Number of links for current phrase
                      '{current_phrase}': {len(current_links)}""")
                print("----------------")
    ...
    def save_word_counts(self, counts: int,
                         prefix: str=None,
                         postfix: str=None):
